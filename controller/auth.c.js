...
const validateRegisterField = async  (req, res) => {
    ...
    if(password){
        ...
        if(!passwordRegex.test(password)){
            res.status(400).json('Password must contain at least 1 lowercase, 1 uppercase, 1 number')
        }
    }
    res.json('')
}
...
module.exports = {renderLogin, renderRegister, register, renderHomepage, validateRegisterField}